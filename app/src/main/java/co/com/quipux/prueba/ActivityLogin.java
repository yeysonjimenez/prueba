 ...
 */
public class ActivityLogin extends BaseActivity implements LoaderCallbacks<Cursor> {
  ...
  private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
    ...
    ArrayAdapter<String> adapter =
        new ArrayAdapter<>(ActivityLogin.this, android.R.layout.simple_dropdown_item_1line,
